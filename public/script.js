...
const heroSubtitles = [
  '<span class="subtitle-pc">㈜스마트계측은<br>AI를 활용한 자동화계측시스템 기술로<br>건설공사현장에서 안정적이며 정밀한 측정을 선두하는 기업입니다.</span><span class="subtitle-mobile">㈜스마트계측은<br>AI를 활용한 자동화계측시스템 기술로<br>건설공사현장에서 안정적이며 정밀한 측정을<br>선두하는 기업입니다.</span>',
